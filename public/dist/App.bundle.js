...
var mapOptions = {
    center: { lat: 45.2, lng: -79.8 },
    zoom: 10
};

function loadPlaces(map) {
    var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 45.2;
...
function makeMap(mapDiv) {
    ...
    autocomplete.addListener('place_change', function () {
        ...
        loadPlaces(map, place.geometry.loca.lat(), place.geometry.loca.lng());
    });
}
